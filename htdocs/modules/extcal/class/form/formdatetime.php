...
//         $form->addElement($test);
        ...
        $startTime = new XoopsFormSelect(
            '', 'event_start[time]', $startDatetime['hours'] * _EXTCAL_TS_HOUR + 600 * ceil($startDatetime['minutes'] / 10)
        );
        ...
        $endTime = new XoopsFormSelect(
            '', 'event_end[time]', $endDatetime['hours'] * _EXTCAL_TS_HOUR + 600 * ceil($endDatetime['minutes'] / 10)
        );
